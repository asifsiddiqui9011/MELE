    ...
    <Container>
      ...
      >
        {serviceData.map((card, index) => (
          <SwiperSlide
            key={index}
            style={{boxShadow:"2px 2px 10px rgba(0,0,0,0.2),-2px -2px 10px rgba(0,0,0,0.4)"}}
            className="bg-white p-6 flex-col transition duration-300 ease-in-out hover:bg-gradient-to-r hover:from-blue-300 hover:via-lightblue hover:to-pink-300 rounded-2xl flex justify-center items-center"
          >
            <div className="flex flex-col items-center justify-center gap-2" >
              <img
              ...
              <div className="mt-2">
                <h1 className="md:text-lg text-xs text-gray-600" style={{display: '-webkit-box',WebkitBoxOrient: 'vertical',WebkitLineClamp: '3',overflow: "hidden", textOverflow: "ellipsis",}}>
                  {card.desc}
                </h1>
              </div>
            </div>
